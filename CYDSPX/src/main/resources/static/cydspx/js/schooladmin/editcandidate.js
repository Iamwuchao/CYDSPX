...
var servicetest = ["开课","讲座"];
var vocationtest = ["采矿业","制造业"];
var prizeList = [
		...
		success:function(data){
			...
			vue = new Vue({
		        ...
		        data: {
					...
					cert_type:candidate.cert_type,
					cert_no:candidate.cert_no,
					address:candidate.address,
					postal_code:candidate.postal_code,
					mobile_phone:candidate.mobile_phone,
					tel_phone:candidate.tel_phone,
					email:candidate.email,
					edu_type:candidate.edu_type,
					edu_hierarchy:candidate.edu_hierarchy,
...
//					service_intention:data.services,
		            ...
		            stateList:listData.stateList,
		            cert_typeList:cert_typeList,
		            edu_typeList:listData.edu_typeList,
		            edu_hierarchyList:listData.edu_hierarchyList,
		            subject_categoryList:listData.subject_categories,
		            degree_typeList:listData.degree_types,
		            vocationList:listData.vocations,
		            titleList:listData.titles,
		            service_intentionList:listData.services,
